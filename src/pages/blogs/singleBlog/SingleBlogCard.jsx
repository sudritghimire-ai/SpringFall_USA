...
<div className="flex pt-16 max-w-screen-xl mx-auto px-4">
        {/* Desktop Sidebar TOC */}
          ...
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-outfit">
            ...
            <header className="text-center mb-16 pb-12 border-b border-slate-200/60 relative">
              ...
              <div className="relative">
                <div className="mb-8">
                  <span className="inline-flex items-center gap-3 px-6 py-3 border-2 border-blue-200/60 text-blue-800 rounded-full text-sm font-semibold tracking-wider uppercase font-outfit bg-white/80 backdrop-blur-sm hover:border-blue-300 hover:shadow-lg transition-all duration-300">
...
<section className="mt-0 pt-0 border-t-2 border-gradient-to-r from-amber-600 to-amber-400 relative -translate-y-8">
