...
const RelatedInstitutionsSidebar = ({ similarUniversities }) => {
  ...
  return (
    <div className="hidden xl:block w-72 fixed right-[18rem] top-20 h-[calc(100vh-5rem)] bg-white/95 backdrop-blur-xl shadow-2xl border border-slate-200/60 rounded-2xl overflow-hidden z-20 transition-all duration-300">
      <div className="h-full flex flex-col">
        {/* Header */}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-amber-50/20 relative">
      ...
      <div className="flex pt-16 max-w-7xl mx-auto px-2 md:px-4">
        ...
        {/* Main Content */}
        <div className="flex-1 lg:ml-60 xl:ml-64 xl:mr-[22rem] transition-all duration-300">
