...
const RelatedInstitutionsSidebar = ({ similarUniversities }) => {
  ...
  return (
    <div className="hidden xl:block w-72 fixed right-40 top-20 h-[calc(100vh-5rem)] bg-white/95 backdrop-blur-xl shadow-2xl border border-slate-200/60 rounded-2xl overflow-hidden z-20 transition-all duration-300">
      <div className="h-full flex flex-col">
        {/* Header */}
