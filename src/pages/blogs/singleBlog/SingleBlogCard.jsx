    ...
    <div className="relative">
      ...
      <div className="lg:hidden sticky top-0 z-10 bg-white shadow-md p-3">
        ...
        >
          ...
          <span className="ml-2">{tocOpen ? "▲" : "▼"}</span>
        </button>
            ...
            {similarUniversities && similarUniversities.length > 0 && (
              <div className="border-t pt-6 lg:pt-8 mt-6 lg:mt-8">
                ...
                {similarUniversities.map((university) => (
                  <div
                    key={university.id}
                    className="bg-gray-50 p-4 lg:p-6 rounded-lg mb-4 lg:mb-6"
                  >
                    <h3 className="text-lg lg:text-xl font-semibold text-gray-700 mb-2 lg:mb-3">
                      {university.name}
                    </h3>
