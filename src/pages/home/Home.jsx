          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-center">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-300 to-blue-500 bg-clip-text text-transparent">Nepal Student Association</h2>
              </div>
              ...
              <div className="flex space-x-4 mt-4">
                ...
                <a href="https://www.instagram.com/nsa.txst/?hl=en" className="w-10 h-10 rounded-full bg-gray-700 hover:bg-blue-500 flex items-center justify-center transition-all duration-300 transform hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:" className="text-white hover:text-blue-400 transition-colors duration-300"></a>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-lg bg-gray-800 flex items-center justify-center mr-3 mt-1 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 002 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400">Phone:</p>
                    <a href="tel:+" className="text-white hover:text-blue-400 transition-colors duration-300">+(977) </a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative border-t border-gray-800 py-6">
          <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} <span className="text-blue-400 font-medium">Nepal Student Association</span>. All rights reserved.
            </div>
