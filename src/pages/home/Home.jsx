        ...
        <div className="container mx-auto px-6 pt-16 pb-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex space-x-4 mt-4">
                <a
                  href="https://www.facebook.com/groups/3600099270261022/"
                  className="w-10 h-10 rounded-full bg-gray-700 hover:bg-blue-500 flex items-center justify-center transition-all duration-300 transform hover:scale-110"
                >
                ...
                <a
                  href="https://www.instagram.com/springfall_07?igsh=MXhxMmZmMXl4aWppeA=="
                  className="w-10 h-10 rounded-full bg-gray-700 hover:bg-blue-500 flex items-center justify-center transition-all duration-300 transform hover:scale-110"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:support@springfallus.org"
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center">
            <div className="relative max-w-3xl mx-auto px-6">
              <svg
                className="absolute top-0 left-0 w-8 h-8 text-gray-700 transform -translate-x-6 -translate-y-6"
                fill="currentColor"
                viewBox="0 0 32 32"
              >
              ...
              <p className="italic text-gray-300 text-lg">
                Gravity is not just a force, it's the universe's way of saying that what goes up must come down, but
                dreams defy even the strongest pulls.
              </p>
              <svg
                className="absolute bottom-0 right-0 w-8 h-8 text-gray-700 transform translate-x-6 translate-y-6"
                fill="currentColor"
                viewBox="0 0 32 32"
              >
        ...
        <div className="relative border-t border-gray-800 py-6">
          <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} <span className="text-blue-400 font-medium">SpringFallUSA</span>. All
              rights reserved.
            </div>
