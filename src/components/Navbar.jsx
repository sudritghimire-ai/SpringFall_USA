            ...
            <nav className='container mx-auto flex justify-between items-center px-5 relative z-10'>
                ...
                <a href='/' className="flex items-center space-x-3 group">
                    <div className="relative overflow-hidden rounded-full">
                        ...
                        <img src='/logo1.jpg' alt='Logo' className='h-12 w-12 object-cover rounded-full relative z-10 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(30,115,190,0.3)] transition-all duration-500' />
                    </div>
