...
var d = class _d {
  ...
  static findAllInputs(e) {
    return No(e.querySelectorAll(_d.allInputsSelector)).reduce((t, o) => _d.isNativeInput(o) || _d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ..._d.getDeepestBlockElements(o)], []);
  }
  /**
...
var R = class _R extends Oe {
   ...
   */
  compose() {
    const e = d.make("div", _R.CSS.wrapper), t = d.make("div", _R.CSS.content), o = this.toolInstance.render();
...
var Be = class _Be extends E {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d.make("div", _Be.CSS.overlay, {}), i = d.make("div", _Be.CSS.overlayContainer, {}), s = d.make("div", _Be.CSS.rect, {});
