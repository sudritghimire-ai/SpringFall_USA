...
var m = class _m {
  ...
  render() {
    ...
    const { html: i } = _m.services[this.data.service], r = document.createElement("div"), e = document.createElement("div"), o = document.createElement("template"), l = this.createPreloader();
  ...
  onPaste(i) {
    var c;
    const { key: r, data: e } = i.detail, { regex: o, embedUrl: l, width: t, height: a, id: n = (u) => u.shift() || "" } = _m.services[r], h = (c = o.exec(e)) == null ? void 0 : c.slice(1), d = h ? l.replace(/<%= remote_id %>/g, n(h)) : "";
    this.data = {
      service: r,
      source: e,
      embed: d,
  ...
  static prepare({ config: i = {} }) {
    ...
    const o = Object.entries(r).filter(([t, a]) => typeof a == "boolean" && a === true).map(([t]) => t), l = Object.entries(r).filter(([t, a]) => typeof a == "object").filter(([t, a]) => _m.checkServiceConfig(a)).map(([t, a]) => {
    ...
    o.length && (e = e.filter(([t]) => o.includes(t))), e = e.concat(l), _m.services = e.reduce((t, [a, n]) => a in t ? (t[a] = Object.assign({}, t[a], n), t) : (t[a] = n, t), {}), _m.patterns = e.reduce((t, [a, n]) => (n && typeof n != "boolean" && (t[a] = n.regex), t), {});
  }
  /**
  ...
  static checkServiceConfig(i) {
    ...
    return n = n && (a !== void 0 ? a instanceof Function : true), n = n && (l !== void 0 ? Number.isFinite(l) : true), n = n && (t !== void 0 ? Number.isFinite(t) : true), n;
  }
  /**
